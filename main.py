...
COLORS = [(0, 0, 0), (17, 34, 51), (34, 68, 102), (51, 102, 153), (68, 136, 204), (85, 170, 255), (102, 204, 50),
          (119, 238, 101), (136, 16, 152), (153, 50, 203), (170, 84, 254), (187, 118, 49), (204, 152, 100),
          (221, 186, 151), (238, 220, 202), (255, 254, 253)]
...
def get_pixel_color(image_data, width, x, y):
    # 计算偏移量
    offset = (y * width + x) * 4
    b = image_data[offset]
...
def start(xy):
    game_region = (xy['identify_txy'][0] - 1, xy['identify_txy'][1] - 1, xy['identify_bxy'][0] + 1, xy['identify_bxy'][1] + 1)
    w, h = game_region[2] - game_region[0], game_region[3] - game_region[1]
    ...
    while flag:
        ...
        try:
            key = color_xy[(get_pixel_color(img, w, 1, 1), get_pixel_color(img, w, w - 1, h - 1))]
        except KeyError:
            count += 1
            if count > 40:
                time.sleep(0.2)
